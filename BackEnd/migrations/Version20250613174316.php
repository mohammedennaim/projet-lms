 ...
 */
final class Version20250613174316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE ressource CHANGE contenu contenu VARCHAR(500) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE ressource CHANGE contenu contenu VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
