 ...
 */
final class Version20250703105658 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE affectation ADD quiz_id INT DEFAULT NULL, ADD ressource_id INT DEFAULT NULL, CHANGE cours_id cours_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE affectation ADD CONSTRAINT FK_F4DD61D3853CD175 FOREIGN KEY (quiz_id) REFERENCES quiz (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE affectation ADD CONSTRAINT FK_F4DD61D3FC6CD52A FOREIGN KEY (ressource_id) REFERENCES ressource (id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_F4DD61D3853CD175 ON affectation (quiz_id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_F4DD61D3FC6CD52A ON affectation (ressource_id)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_question_response ADD answered_at DATETIME NOT NULL, ADD time_spent_seconds INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_quiz_response ADD total_questions INT NOT NULL, ADD correct_answers INT NOT NULL, ADD time_spent_seconds INT NOT NULL, ADD feedback LONGTEXT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE affectation DROP FOREIGN KEY FK_F4DD61D3853CD175
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE affectation DROP FOREIGN KEY FK_F4DD61D3FC6CD52A
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_F4DD61D3853CD175 ON affectation
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_F4DD61D3FC6CD52A ON affectation
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE affectation DROP quiz_id, DROP ressource_id, CHANGE cours_id cours_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_question_response DROP answered_at, DROP time_spent_seconds
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_quiz_response DROP total_questions, DROP correct_answers, DROP time_spent_seconds, DROP feedback
        SQL);
    }
}
