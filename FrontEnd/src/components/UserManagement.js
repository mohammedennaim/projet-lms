    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        <div className="text-center">
          ...
          <p className="mt-4 text-blue-600 font-medium animate-pulse">Chargement des utilisateurs...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="mt-8 flex flex-col lg:flex-row gap-4">
            ...
            <div className="relative md:w-64">
              ...
              >
                ...
                <option value="employée">Employés</option>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50">
                  <th className="py-3 px-4 text-left text-gray-600 font-medium text-sm tracking-wider">Nom</th>
                  <th className="py-3 px-4 text-left text-gray-600 font-medium text-sm tracking-wider">Email</th>
                  <th className="py-3 px-4 text-left text-gray-600 font-medium text-sm tracking-wider">Rôle</th>
                    ...
                    return (
                      <tr key={user.id} className="hover:bg-blue-50/50 transition-colors">
                        <td className="py-3 px-4">
                          <div className="flex items-center">
                            <div className="w-9 h-9 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 flex items-center justify-center text-white font-medium mr-3">
          ...
          {pagination.pages > 1 && (
            <div className="py-4 px-6 flex justify-between items-center border-t border-gray-100">
              <div className="text-sm text-gray-500">
                Affichage de {Math.min((page - 1) * pagination.limit + 1, pagination.total)} à {Math.min(page * pagination.limit, pagination.total)} sur {pagination.total} utilisateurs
              </div>
